...
-- Recreate with expanded consultant access
-- Consultants can see contacts where:
-- 1. consultant_id = their user id (assigned as consultant)
-- 2. assigned_to = their user id (assigned to handle)
